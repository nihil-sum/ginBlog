...
type Model struct {
	CreatedAt common.JsonFormatTime `json:"createdAt"`
	UpdatedAt common.JsonFormatTime `json:"updatedAt"`
...
func (p PageInfo) GetOffset() int { return (p.GetPage() - 1) }
